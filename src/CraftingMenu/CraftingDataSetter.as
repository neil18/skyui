		...
		switch (a_entryObject.formType) {
			...
			case Form.TYPE_AMMO:
				...
				if (a_entryObject.keywords["REQ_KW_AmmoWeight_Light"] != undefined) {
					...
					a_entryObject.infoValueWeight = Math.round(a_entryObject.value / 0.1);
					...
					a_entryObject.infoValueWeight = Math.round(a_entryObject.value / 0.2);
					...
					a_entryObject.infoValueWeight = Math.round(a_entryObject.value / 0.3);
					...
					a_entryObject.infoValueWeight = Math.round(a_entryObject.value / 0.5);
